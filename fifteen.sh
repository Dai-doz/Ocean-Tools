...
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system" "ro.build.display.id" "Built by OceanTools+                       ${B_ID} ${B_V} "
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "product" "ro.build.display.id" "Built by OceanTools+                     ${B_ID} ${B_V} "
